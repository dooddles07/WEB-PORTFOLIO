...
export function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden border-t border-line px-6 pb-24 pt-28 sm:px-14 lg:pt-32">
      <div
        aria-hidden
        ...
        <Reveal delay={0.25}>
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <MagneticButton
              ...
              className="grad-bg flex items-center rounded-full px-9 py-4 font-display text-base font-semibold text-white shadow-[0_0_40px_rgba(139,92,246,0.35)]"
            >
              {profile.email}
            </MagneticButton>
            <MagneticButton
